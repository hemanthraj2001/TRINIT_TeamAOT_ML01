...
bot = telebot.TeleBot("5201573837:AAHBMJkN25zzndRAch0hqWCOKXggVO2Fowc")

@bot.message_handler(commands=['start', 'help'])
def send_welcome(message):
	bot.reply_to(message, "Welcome to covid helper chat bot")
...
def chat(message):
    ...
    while True:
        ...
        model = model.load('model.tflearn.data-00000-of-00001')
        ...
        if results[results_index] > 0.7:
            ...
            bot.reply_to(message,"I am sorry but I can't understand" )
